...
#define TEXT "M5stack %Fonts% demo by zell" // Text that will be printed on screen in any font
#define TEXT2 "feb.2020, by Zell, tudzl@hotmail.de" // Text that will be printed on screen in any font
...
void loop() {
  ...
  M5.Lcd.drawString(TEXT2, 20, 180, GFXFF);// Print the string name of the font
  delay(2000);
