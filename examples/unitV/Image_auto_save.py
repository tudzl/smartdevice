...
if auto_save:
    print("#creat /autosave folder")
    try:
        os.mkdir("/sd/autosave")
    except Exception as e:
        pass
...
while(condition):
    ...
    if auto_save:
       ...
       if (Zeit_tmp > Zeit_interval*1000):
         if TF_Card_OK:
            ...
            print("---------------------------")
            print("#:autosave: Image "+str(autosave_cnt)+"saved to SD card!")
            print("---------------------------")
    ...
    if Btn_A.value() == 0 and isButtonPressedA == 0:
                if TF_Card_OK:
                    ...
                    time.sleep(0.5)
                    print("---------------------------")
                    print("Image "+str(currentImage)+"saved to SD card!")
                    print("---------------------------")
    ...
    if Btn_B.value() == 0 and isButtonPressedB == 0:
                ...
                debug_print_EN = not debug_print_EN
                time.sleep(0.5)
                RGB_LED_RED()
    if Btn_B.value() == 1:
                isButtonPressedB = 0
