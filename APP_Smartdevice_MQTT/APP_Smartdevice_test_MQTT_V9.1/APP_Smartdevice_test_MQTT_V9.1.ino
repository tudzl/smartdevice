...
/***********************Smart device with 8 sensor*****************************************
   APP_SMartdevice_test_MQTT.ino
   require external Arduino Libraries for sensors:
   ICM20948,MFRC522,BME280,MCP9808,MAX30205
   The default configuration to these sensors is changed to fit the application
   The sensor readings are calibrated with multiple Fluke measurement devices.
   Original Creation Date: April 17 2019
   This code is written by L.ZHOU for Staeubli smart device project
   <tudzl@hotmail.de>
...
#include <ZFilter.h>    //adaptive filter
#include <MAX44009.h>  //Wide 0.045 Lux to 188,000 Lux Range
#include "Adafruit_MCP9808.h"
#include "Protocentral_MAX30205.h" //high prescision T sensor
...
#include <DPEng_ICM20948_AK09916.h> // look for better libs? 
//NCIR
