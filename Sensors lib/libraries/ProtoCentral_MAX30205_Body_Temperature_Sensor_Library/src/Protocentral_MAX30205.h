...
/////////////////////////////////////////////////////////////////////////////////////////
// for smart device NCIR PCB
#define MAX30205_ADDRESS        0x49  // 8bit address converted to 7bit
...
private:
  ...
  void    I2CwriteBytes(uint8_t address, uint8_t subAddress, uint16_t data);
  uint8_t I2CreadByte(uint8_t address, uint8_t subAddress);
  uint16_t I2CreadWord(uint8_t address, uint8_t subAddress);
