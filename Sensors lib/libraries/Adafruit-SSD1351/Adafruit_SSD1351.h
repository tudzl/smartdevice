...
#define SSD1351_CMD_CONTRASTMASTER 0xC7 ///< See datasheet: Master Current Control  This command is to control the segment output current by a scaling factor. This factor is common to color A, B and C. The chip has 16 master control steps.
...
class Adafruit_SSD1351 : public Adafruit_SPITFT {
  public:
	...
	//void begin_new(uint32_t freq = 0);


    void begin(uint32_t freq = 0),
	     begin_new(uint32_t freq = 0),
