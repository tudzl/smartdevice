...
/***************************************************************************************
** Function name:           setTextColor
** Description:             Set the font foreground and background colour RGB565
***************************************************************************************/
void TFT_eSPI::setTextColor(uint32_t c, uint32_t b)
{
	
  if( c > 0xFFFF){
  textcolor = (((c&0xf80000)>>8) + ((c&0xfc00)>>5) + ((c&0xf8)>>3));
  //textcolor   = c;
  //textbgcolor = b;
  textbgcolor = (((b&0xf80000)>>8) + ((b&0xfc00)>>5) + ((b&0xf8)>>3));
  }
  else {
	   textcolor   = c;
  textbgcolor = b;
...
/***************************************************************************************
** Function name:           setTextColor  RGB888 mode
** Author: 					zell
** Description:             Set the font foreground and background colour
***************************************************************************************/

void TFT_eSPI::setTextColor888(uint32_t c, uint32_t b)
{
  // if( c > 0xFFFF){
  textcolor = (((c&0xf80000)>>8) + ((c&0xfc00)>>5) + ((c&0xf8)>>3));
  //textcolor   = c;
