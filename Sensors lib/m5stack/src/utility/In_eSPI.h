...
//RGB888 24bit color
#define TFT_IVORY       0xFFFFF0
#define TFT_Crimson     0xDC143C
#define TFT_MediumSlateBlue		0x7B68EE
#define TFT_DarkSlateBlue       0x483D8B
#define	TFT_DoderBlue 	0x1E90FF
#define	TFT_Azure		0xF0FFFF
#define	TFT_Auqamarin	0x7FFFAA
#define	TFT_Cornislk    0xFFF8DC
#define	TFT_OrangeRed	0xFF4500
#define	TFT_Silver   0xC0C0C0



//#define TFT_GhostWhite  0xF8F8FF
...
class TFT_eSPI : public Print {
 ...
 public:
  ...
  void     drawRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color),
           ...
           setTextColor(uint32_t fgcolor, uint32_t bgcolor),
