...
label1 = M5TextBox(10, 40, "IIC address list", lcd.FONT_DejaVu24,0xFFFFAA, rotate=0)
label_info1 = M5TextBox(20, 200, "iic sacn loop:", lcd.FONT_DejaVu18,0xDFCF1F, rotate=0)
label_info2 = M5TextBox(20, 220, "text loop:", lcd.FONT_DejaVu18,0xDFCF1F, rotate=0)
label_info3 = M5TextBox(160, 220, "sleep:", lcd.FONT_DejaVu18,0xDFCF1F, rotate=0)
