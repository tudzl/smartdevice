...
neopixel0.setBrightness(Pixel_brightness)
label0 = M5TextBox(6, 10, "Pixel puzzle demo v0.6", lcd.FONT_DejaVu24,0xFFFFFF, rotate=0)
...
while True:
  ...
  try:
      ...
      if Pixel_pos == Pixel_target_index:
         ...
         wait(0.15)
         win_flag()
         Pixel_target_index =  random.randint(1, 56) +math.fmod(run_cnt/8)
         label_pixel.setText("Pixel: "+str(Pixel_pos)+" Col:"+str(Pixel_col_num)+ "Target:"+str(Pixel_target_index))
         init_puzzle(Pixel_pos)
         wait(0.25)
