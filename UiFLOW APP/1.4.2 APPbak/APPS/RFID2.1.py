...
# version 2.0, added SD mount check, 2019.7.24
...
rtc.init((2019, 8, 7, 9, 0, 0, 0, 0))

label_time = M5TextBox(20, 20, "TIme: ", lcd.FONT_Default,0xDFCFCF, rotate=0)
label0 = M5TextBox(20, 40, "NFC status:", lcd.FONT_Default,0xCFCFFF, rotate=0)
label_data = M5TextBox(20, 60, "RFID ID:", lcd.FONT_Comic,0xBFDFAA, rotate=0)
label_Block_data = M5TextBox(20, 90, "RFID data:", lcd.FONT_Comic,0xCFCF9A, rotate=0)
label_data_hall = M5TextBox(20, 120, "Hall sensor:", lcd.FONT_Default,0xAFCFFF, rotate=0)
label_data_T_CPU = M5TextBox(180, 120, "T_CPU:", lcd.FONT_Default,0xAFCFFF, rotate=0)
...
while True:
  ...
  if rfid0.isCardOn():
    ...
    Block_data = rfid0.readBlockStr(1)
    print(Block_data)
    label_Block_data.setText("Data: " +str(Block_data) )
    lcd.image(lcd.CENTER+100, lcd.CENTER-60, 'res/RFID_icon.jpg') #test
  else:
    label0.setText("NFC status: card removed")  
