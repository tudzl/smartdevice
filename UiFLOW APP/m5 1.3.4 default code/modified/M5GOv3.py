#modified by l.zhou  15.7.2019
#gyro SUPPORT sh200Q and MPU9250
...
def micro_loop(obj):
    ...
    lcd.print( "Mic Raw: "+str(MIC_RAW), 180, 190, 0xFFAAFF)
def micro_end(obj):
    obj['adc'].deinit()
    unit.deinit()
    obj = {}
...
def ball_move(x, y, color):
    ...
    if (not x == _pos[0]) or (not y == _pos[1]):
        ...
        #lcd.circle(x, y, r [,clr, fillcolor]) 
        lcd.circle(x, y, 9, color, color-100)  # draw
        _pos[0] = x
        _pos[1] = y
