...
label_MQTT_Rs = M5TextBox(15, 140, "Rx_echo:", lcd.FONT_DejaVu18,0x1F1FF2, rotate=0) #MQTT received msg display
...
wait(0.1)
m5mqtt.subscribe(str('test_ESP32_smartdevice'), fun_echo_esp32_mqtt)  #will echo received msg
wait(0.1)
...
while True:
  ...
  if MQTT_Alert_send_flag ==1:
      label2.setText("Alert_send:"+"Alert:"+Alert_payload)
      m5mqtt.publish(str('test_ESP32_smartdevice'),"Alert:"+Alert_payload)
      wait_ms(200)
